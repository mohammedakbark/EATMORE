            ...
            Padding(
              ...
              child: TextField(
                decoration: InputDecoration(
                  ...
                  contentPadding: const EdgeInsets.only(left: 10, top: 10, bottom: 10), // Adjust the left padding here
                ),
              ),
            ),
            Padding(
              ...
              child: ListTile(
                title:const Text("Samosa",style: TextStyle(fontWeight: FontWeight.bold)),
                leading: Container(
                height: 100,
                width: 95,
                ...
                subtitle: const Text("₹10.00",style: TextStyle(fontWeight: FontWeight.bold)),
              ),
            ),
